...
export default function MenuManagementPage() {
    ...
    const handleCreate = async (e) => {
        ...
        console.error("❌ 發生錯誤:", error.message || error.toString());
        }
    };
...
const handleDelete = async (id) => {
    ...
    try {
        ...
        console.error("❌ 刪除餐點失敗:", err.message || err.toString());
    }
};
...
<input
  ...
  onChange={async (e) => {
    ...
    if (file) {
      ...
      console.log("圖片上傳成功，網址為：", url);
      console.log("上傳前的 newItem：", newItem);
      setNewItem((prev) => {
        const updated = { ...prev, imageUrl: url };
        console.log("🆕 寫入後的 newItem：", updated);
        return updated;
      });
      setUploading(false);
    }
